...
def getLocation(area):
    # url = 'https://nominatim.openstreetmap.org/search/' + urllib.parse.quote(area) +'?format=json'
    # url = f'https://nominatim.openstreetmap.org/search?q={area}'
    # print(url,'urlurlurl')
    # print('urllllll:',requests.get(url))
...
def getDistanceOld(lat1, lon1, lat2, lon2):
    R = 6373.0
    dlon = lon2 - lon1
    dlat = lat2 - lat1
